...
import FullBlogSkeleton from '../../shared/components/FullBlogSkeletonUI';
...
const FullBlog = () => {
    ...
    useEffect(() => {
     ...
     if (!blog) return <FullBlogSkeleton />;
        ...
        <div className='fullblog_maincontainer'>
            <div className='fullblog_container'>
                ...
                <div className='profile_container'>
                    ...
                    <FollowButton currentUser={current_user} targetUser={target_userId} />
                    <p>5 min Read </p>
